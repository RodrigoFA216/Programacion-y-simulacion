...
struct ComplejoRectangular {
    double real;
    double imaginario;
};

// Función para convertir de formato polar a rectangular
struct ComplejoRectangular convertirAPolar(double magnitud, double angulo) {
    struct ComplejoRectangular resultado;
...
int main() {
    ...
    struct ComplejoRectangular resultadoRectangular = convertirAPolar(magnitud, angulo);
